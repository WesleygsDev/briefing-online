                     ...
                     <div class="container containerFild">
                        ...
                        <div class="container">
                           ...
                           <?php 
                                ...
                                $dados1 = $url;
                                $getBriefing = substr($dados1, -14, 29);
                            
                                $select = "SELECT * FROM briefing WHERE link_ref='$getBriefing'";
                                $exe = mysqli_query($con, $select);
                                while($dado=mysqli_fetch_array($exe)){
                                    
                                $titulobriefing = $dado['titulo_briefing'];
                                echo "<center><a href='home' class='btn btn-default' style='border:solid 1px #ccc;'>Fechar visualização</a></center><br>";
